...
public class FeatureImpl extends IdentifiableImpl implements Feature {
	...
	public EList<Feature> getFeatures() {
		if (features == null) {
			features = new EObjectContainmentWithInverseEList<Feature>(Feature.class, this,
					FeatJARPackage.FEATURE__FEATURES, FeatJARPackage.FEATURE__PARENT);
		}
		return features;
	}
	...
	public void setParent(Feature newParent) {
		if (newParent != eInternalContainer()
			...
			if (newParent != null)
				msgs = ((InternalEObject) newParent).eInverseAdd(this, FeatJARPackage.FEATURE__FEATURES, Feature.class,
						msgs);
