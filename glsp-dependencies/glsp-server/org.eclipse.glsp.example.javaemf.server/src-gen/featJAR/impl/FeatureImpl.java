...
public class FeatureImpl extends IdentifiableImpl implements Feature {
   ...
   public EList<Feature> getFeatures() {
      if (features == null) {
         features = new EObjectContainmentWithInverseEList<Feature>(Feature.class, this, FeatJARPackage.FEATURE__FEATURES, FeatJARPackage.FEATURE__PARENT);
      }
      return features;
   }
   ...
   public void setParent(Feature newParent) {
      if (newParent != eInternalContainer() || (eContainerFeatureID() != FeatJARPackage.FEATURE__PARENT && newParent != null)) {
         ...
         if (newParent != null)
            msgs = ((InternalEObject)newParent).eInverseAdd(this, FeatJARPackage.FEATURE__FEATURES, Feature.class, msgs);
         msgs = basicSetParent(newParent, msgs);
         if (msgs != null) msgs.dispatch();
      }
      else if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, FeatJARPackage.FEATURE__PARENT, newParent, newParent));
   }
   ...
   public void setOptional(boolean newOptional) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, FeatJARPackage.FEATURE__OPTIONAL, oldOptional, optional));
   }
   ...
   public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
      switch (eContainerFeatureID()) {
         case FeatJARPackage.FEATURE__PARENT:
            return eInternalContainer().eInverseRemove(this, FeatJARPackage.FEATURE__FEATURES, Feature.class, msgs);
      }
