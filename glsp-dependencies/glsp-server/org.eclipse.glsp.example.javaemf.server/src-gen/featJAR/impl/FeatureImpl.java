 ...
 * </p>
 * <ul>
 *   <li>{@link featJAR.impl.FeatureImpl#getGroup <em>Group</em>}</li>
...
public class FeatureImpl extends MinimalEObjectImpl.Container implements Feature {
	...
	public EList<Group> getGroup() {
		if (group == null) {
			group = new EObjectWithInverseResolvingEList.ManyInverse<Group>(Group.class, this,
					FeatJARPackage.FEATURE__GROUP, FeatJARPackage.GROUP__FEATURE);
		}
		return group;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case FeatJARPackage.FEATURE__GROUP:
