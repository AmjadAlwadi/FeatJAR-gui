...
public class FeatJARPackageImpl extends EPackageImpl implements FeatJARPackage {
   ...
   public static FeatJARPackage init() {
      ...
      FeatJARPackageImpl theFeatJARPackage = registeredFeatJARPackage instanceof FeatJARPackageImpl ? (FeatJARPackageImpl)registeredFeatJARPackage : new FeatJARPackageImpl();
   ...
   public void initializePackageContents() {
      ...
      initEReference(getFeature_Features(), this.getFeature(), this.getFeature_Parent(), "features", null, 0, -1, Feature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
      initEReference(getFeature_Parent(), this.getFeature(), this.getFeature_Features(), "parent", null, 0, 1, Feature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
